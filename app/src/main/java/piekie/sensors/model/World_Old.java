...
public class World_Old {
    ...
    public World_Old(Scene scene, Bundle info) {
        this.scene = scene;
        this.dumbo = new Dumbo();
        ...
        dumbo.setX(info.getInt("x", res.getInteger(R.integer.default_dumbo_x)));
        dumbo.setY(info.getInt("y", res.getInteger(R.integer.default_dumbo_y)));
        ...
        if (scene.equals(Scene.SECOND)) {
            ...
            block.setSize(res.getInteger(R.integer.default_dumbo_size));
        ...
        dumbo.setSize(info.getInt("size", res.getInteger(R.integer.default_dumbo_size)));
        ...
        dumbo.setAngle(info.getInt("angle", res.getInteger(R.integer.default_dumbo_angle)));
